...
sudo apt-get install git clang cmake make gcc g++ libmysqlclient-dev libmysqlclient-dev libssl-dev libbz2-dev libreadline-dev libncurses-dev libboost-all-dev mysql-server p7zip --assume-yes
