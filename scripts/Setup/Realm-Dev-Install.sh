...
echo "##########################################################"
echo ""
mysql --host=$REALM_DB_HOST --port=$REALM_DB_PORT -u $REALM_DB_USER -p$REALM_DB_PASS -e "CREATE DATABASE ${REALM_DB_USER}_world DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;"
mysql --host=$REALM_DB_HOST --port=$REALM_DB_PORT -u $REALM_DB_USER -p$REALM_DB_PASS -e "CREATE DATABASE ${REALM_DB_USER}_character DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;"
mysql --host=$REALM_DB_HOST --port=$REALM_DB_PORT -u $REALM_DB_USER -p$REALM_DB_PASS -e "GRANT USAGE ON ${REALM_DB_USER}_world.* TO '${REALM_DB_USER}'@'localhost' IDENTIFIED BY '$REALM_DB_PASS' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0;"
mysql --host=$REALM_DB_HOST --port=$REALM_DB_PORT -u $REALM_DB_USER -p$REALM_DB_PASS -e "GRANT USAGE ON ${REALM_DB_USER}_character.* TO '${REALM_DB_USER}'@'localhost' IDENTIFIED BY '$REALM_DB_PASS' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0;"
mysql --host=$REALM_DB_HOST --port=$REALM_DB_PORT -u $REALM_DB_USER -p$REALM_DB_PASS -e "GRANT ALL PRIVILEGES ON ${REALM_DB_USER}_world.* TO '${REALM_DB_USER}'@'localhost' WITH GRANT OPTION;"
mysql --host=$REALM_DB_HOST --port=$REALM_DB_PORT -u $REALM_DB_USER -p$REALM_DB_PASS -e "GRANT ALL PRIVILEGES ON ${REALM_DB_USER}_character.* TO '${REALM_DB_USER}'@'localhost' WITH GRANT OPTION;"
